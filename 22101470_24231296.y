...
%token GOTO COLON PRINTF PRINTLN
%token IF ELSE FOR WHILE DO CONTINUE RETURN INT FLOAT CHAR VOID DOUBLE SWITCH CASE DEFAULT BREAK ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD SEMICOLON COMMA ID CONST_INT CONST_FLOAT
...
| PRINTLN LPAREN expression RPAREN SEMICOLON {
    outlog << "At line no: " << lines << " statement: PRINTLN LPAREN expression RPAREN SEMICOLON" << endl << endl;
    outlog << "println(" << $3->getname() << ");" << endl << endl;
    $$ = new symbol_info("println(" + $3->getname() + ");", "statement");
}
| PRINTF LPAREN expression RPAREN SEMICOLON {
    outlog << "At line no: " << lines << " statement: PRINTF LPAREN expression RPAREN SEMICOLON" << endl << endl;
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("22101470_24231296.txt", ios::trunc);
